    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <header className="mb-8 space-y-3">
          ...
          <img src="https://tse2.mm.bing.net/th/id/OIP.kWZygGCFmaecCEui3l43kAHaFb?pid=Api&P=0&h=180" alt="Condiments" className="w-full h-60 object-cover rounded-lg mb-4"/>
