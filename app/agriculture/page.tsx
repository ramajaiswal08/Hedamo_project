      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <header className="mb-8 space-y-3">
          <h1 className="text-balance text-2xl font-semibold tracking-tight">
            AgriMart — Fresh Produce
          </h1>
          <img
            src="https://tse1.mm.bing.net/th/id/OIP.wNz6E942T-chyElUDvCVhAHaEV?pid=Api&P=0&h=180"
            alt="AgriMart"
            className="w-full h-60 object-cover rounded-lg mb-4"
          />
          <p className="max-w-2xl text-pretty text-sm text-foreground/70">
            Explore seasonal vegetables from local farms. Tap a card to learn
            more, or expand with the arrow to preview images, specs, and
            features. Selecting a feature opens a detailed popup.
          </p>
